...
from debra.msg import WOD, WOD_dataset
...
def publish_wod():
    ...
    wod_msg = WOD(
        ...
        datasets=[dataset1, dataset2] + [WOD_dataset() for _ in range(30)] # Pad with 30 empty datasets
    )
